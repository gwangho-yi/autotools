...
class Launcher(QWidget):
    ...
    def _build_ui(self):
        ...
        outer.addWidget(self._build_capture_page())

        # motion-clicker 연결 버튼
        conn_row = QHBoxLayout()
        conn_row.setContentsMargins(20, 0, 20, 0)
        self._conn_btn = QPushButton("motion-clicker 연결")
    ...
    def _build_capture_page(self) -> QWidget:
        ...
        self.pause_btn = QPushButton("일시정지 (Ctrl+F6)")
        ...
        p2_l.setSpacing(8)
        self.resume_btn = QPushButton("재시작 (Ctrl+F6)")
    ...
    def _on_conn_toggled(self, checked: bool) -> None:
        if checked:
            ...
            self._conn_btn.setStyleSheet(_CONN_BTN_STYLE.format(color="#8888bb"))
            self._conn_btn.setText("motion-clicker 연결")
